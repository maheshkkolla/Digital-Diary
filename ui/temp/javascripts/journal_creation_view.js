...
export default class JournalCreation extends React.Component {
            ...
            <div className='editor' id="editor">
                <div className="actions">
                    <div className="action">
                        //include _dateTimePicker
                    </div>
                    <div className="action autoCursor" id="locationSelector">
                        //include _locationSelector
                    </div>
                </div>
                <input type='text' className='titleBox title' placeholder="Title ..." id='title'/>
                //include _journalDetails
                <div id='journal' className='journalContent tinymceCustomBody'> </div>
                <div className='editorFooter'>
                    <div className="pull-right">
                        <button className="btn btn-primary" id='clearAll'> Clear All </button>
                        &emsp;
                        <button className="btn btn-primary" id='saveJournal'> Save Journal </button>
                    </div>
